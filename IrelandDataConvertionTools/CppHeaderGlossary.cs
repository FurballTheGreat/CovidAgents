...
namespace IrelandDataConversionTools
{
    ...
    public partial class CppHeaderGlossary : CppHeaderGlossaryBase
    {
        /// <summary>
   ...
   foreach(var theme in Themes) { 
        ...
        foreach(var col in theme.Columns) {
            ...
            this.Write("   DWORD ");
            this.Write(this.ToStringHelper.ToStringWithCulture(col.StructName));
            this.Write(";\r\n");
      } 

            this.Write("} Theme");
            this.Write(this.ToStringHelper.ToStringWithCulture(theme.StructName));
            this.Write(";\r\n\r\n");
 } 
            this.Write("    \r\n\r\ntypedef struct {\r\n");
   ...
   foreach(var theme in Themes) { 
            ...
            this.Write("} SmallPopulationAreaDefinition;\r\n\r\n  \r\n");
...
if ((ThemesValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public class CppHeaderGlossaryBase
    {
        #region Fields
